...
美区 Apple id 充值方式（2026 版）：仍然 pockyt shop
* https://x.com/howie_serious/status/2007641503381008873
:::
...
* 支付宝将地区改为 `美国` > `旧金山`
* 搜索 `pockytshop`
  * 如果搜不到，点击下面的 "优惠"，在推荐列表中可以看到
  * 建议使用之后将该小程序加入收藏，方便以后直接找到
* 2026/08/01 更新：在支付宝中已经不再开放入口，可以到 pockyt 官网充值：
  * https://shop.pockyt.io/brands/all
...
* 在 "设置" 中搜索 "媒体与购买项目"
* 选择 "退出登录"
  * 这个只会退出当前的 Apple Store 账户，不影响 Apple 账户
* 然后切换到美区账号
* 然后在 ChatGPT 的 "设置" 的 "订阅" 中选择 "ChatGPT Plus"
...
* 点击 Apple Store 右上角的头像
* 点击第一行的账户名称
* 下滑，找到 "订阅" 并点击
* 点击 "ChatGPT" ，选择 "查看所有方案"，选择 "ChatGPT Pro 20x"，轻触支付即可

需要注意的是：
* 如果 iPhone 机型较老、ios 版本过低，是不能正常下载 ChatGPT 的
